...
public class UserModel {
    ...
    double getSin(android.location.Location /*класс местоположения*/ start, android.location.Location /*класс местоположения*/ end) {
    ...
    boolean getIsUp(android.location.Location /*класс местоположения*/ start, android.location.Location /*класс местоположения*/ end) {
        double z1 = start.getAltitude();
        double z2 = end.getAltitude();
        return (z2 >= z1);
    }
